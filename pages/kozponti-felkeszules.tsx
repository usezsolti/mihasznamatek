...
export default function KozpontiFelkeszules() {
    ...
    // Központi felvételi témakörök - gimnáziumi felvételi felkészüléshez
    ...
    return (
        <>
            <Head>
                <title>Központi Felkészülés - UniBoost</title>
            </Head>
            <div className="container">
                ...
                <div className="header">
                    <h1>🎯 Központi Felkészülés</h1>
                    <p style={{ fontSize: '1.2rem', color: '#cccccc' }}>
                        Gimnáziumi felvételire felkészítő feladatok témakörök szerint
                    </p>
                </div>
