...
export const SAMPLE_EXAM_TASKS: ExamTaskBankItem[] = [
    ...
    },
    {
        ...
        description: 'Határérték, folytonosság, deriválás alapjai',
        difficulty: 'hard',
        topic: 'Analízis',
        topicId: 'differencialszamitas',
        subjectId: 'analizis1',
        educationLevel: 'university',
        questions: 15,
        timeLimit: 60,
    ...
    },
    {
        ...
        description: 'Hatvány, szorzat, hányados deriválása',
        difficulty: 'hard',
        topic: 'Analízis',
        topicId: 'differencialszamitas',
        subjectId: 'analizis1',
    ...
    },
    {
        id: 'task5',
        title: 'Integrálás',
        description: 'Alapintegrálok, helyettesítés',
        difficulty: 'hard',
        topic: 'Analízis',
        topicId: 'integralas',
        subjectId: 'analizis1',
